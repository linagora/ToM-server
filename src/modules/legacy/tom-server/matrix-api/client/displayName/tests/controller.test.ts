...
describe('DisplayNameController', () => {
  ...
  it('should call displayNameService.update and return 200 if successful', async () => {
    ...
    ;(mockService.update as Mock).mockResolvedValue({ ok: true })
  ...
  it('should return 500 if update fails', async () => {
    ...
    ;(mockService.update as Mock).mockResolvedValue({
      ok: false,
      text: async () => 'DB error'
    })
  ...
  it('should call next with error if exception thrown', async () => {
    ...
    ;(mockService.update as Mock).mockRejectedValue(new Error('fail'))
