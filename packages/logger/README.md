...
logger.silly('This is an info message', {
  endpointPath: '/example/how/to/use/logger',
  httpMethod: 'GET',
  matrixUserId: '@dwho:example.com',
  status: 200,
...
Run `nx build @twake-chat/logger` to build the library.

## Running unit tests

Run `nx test @twake-chat/logger` to execute the unit tests via [Jest](https://jestjs.io).
