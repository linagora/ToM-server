...
## Purpose
Scheduled background jobs for the Matrix Identity Server. Manages periodic tasks such as hash pepper rotation, user data synchronization, and federated identity hash updates. Uses `node-cron` for scheduling.
