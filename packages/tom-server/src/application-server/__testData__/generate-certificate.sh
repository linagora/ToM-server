...
# tu use this script, execute this file with domain as first argument or "-ip" as first argument and host IP as second parameter if you want to set subjectAltName property
