# @twake-chat/federated-identity-service
...
Run `nx build @twake-chat/federated-identity-service` to build the library.

## Running unit tests

Run `nx test @twake-chat/federated-identity-service` to execute the unit tests via [Jest](https://jestjs.io).
